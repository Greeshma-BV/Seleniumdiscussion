...
public class LearnXpath
{
	...
	public static void main(String[] args)  
	{
		...
		driver.findElement(By.xpath("//div[@class='inputs']//input[@id='Password']")).sendKeys("mypassword");
		...
		driver.findElement(By.xpath("//input[contains(@id,'addtocart')]")).clear();
		driver.findElement(By.xpath("//input[contains(@id,'addtocart')]")).sendKeys("4");
		driver.quit();
